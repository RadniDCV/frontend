...
function Home() {
  ...
  const [dataRepsem, setDataRepsem] = useState([]);
  const [dataReplab, setDataReplab] = useState([]);
  const [dataRepben, setDataRepben] = useState([]);
  const [dataReptre, setDataReptre] = useState([]);
  ...
  useEffect(() => {
    axios
      .get("http://192.168.1.9:4000/rptcosem")
      .then((res) => {
        if (res.data.Status === "Success") {
          setDataRepsem(res.data.Result);
          /* console.log("Data", res.data);*/
        } else {
          console.log("Error detallado", res.data);
        }
  ...
  useEffect(() => {
    axios
      .get("http://192.168.1.9:4000/rptcolab")
      .then((res) => {
        if (res.data.Status === "Success") {
          setDataReplab(res.data.Result);
          /* console.log("Data", res.data);*/
        } else {
          console.log("Error detallado", res.data);
        }
  ...
  useEffect(() => {
    axios
      .get("http://192.168.1.9:4000/rptcoben")
      .then((res) => {
        if (res.data.Status === "Success") {
          setDataRepben(res.data.Result);
          /* console.log("Data", res.data);*/
        } else {
          console.log("Error detallado", res.data);
        }
  ...
  useEffect(() => {
    axios
      .get("http://192.168.1.9:4000/rptcotre")
      .then((res) => {
        if (res.data.Status === "Success") {
          setDataReptre(res.data.Result);
          /* console.log("Data", res.data);*/
        } else {
          console.log("Error detallado", res.data);
        }
  ...
  return (
    <div >
      ...
      <div className="d-flex justify-content-center border p-2">
        <div className="card widthcar d-flex justify-content-center">
          <div className="tit_hom hicar">Costo Beneficio Social</div>
          <div className="d-flex justify-content-center ">
            {dataRepben.map((item, index) => (
              <div key="index" className="font1_20">
                {item.CBS} Bs.
              </div>
            ))}
          </div>
        ...
        <div className="card widthcar d-flex justify-content-center">
          <div className="tit_hom  hicar">Costo Laboral</div>
          <div className="d-flex justify-content-center ">
            {dataReplab.map((item, index) => (
              <div key="index" className="font1_20">
                {item.CL} Bs.
              </div>
            ))}
        ...
        <div className="card widthcar d-flex justify-content-center">
          <div className="tit_hom  hicar">Costo por empleado</div>
          <div className="d-flex justify-content-center ">
            {dataRepsem.map((item, index) => (
              <div key="index" className="font1_20">
                {item.CE} Bs.
              </div>
            ))}
        ...
        <div className="card widthcar d-flex justify-content-center">
          <div className="tit_hom  hicar">Tasa de retencion de empleados</div>
          <div className="d-flex justify-content-center ">
            {dataReptre.map((item, index) => (
              <div key="index" className="font1_20">
                {item.TR} %
              </div>
            ))}
